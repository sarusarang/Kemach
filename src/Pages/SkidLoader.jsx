                                    ...
                                    <a href="singleproduct.html" className="text-decoration-none ">
                                        <div className="card h-100" data-aos="fade-down">
                                            ...
                                            <div className="card-body">
                                                ...
                                                <p className="card-text">
                                                    This Bobcat® S450 is our most versatile skid-steer loader - the perfect machine for
                                                    all your loading, carrying and cleaning jobs.
                                                </p>
                                                <a href="#" className=" d-flex justify-content-start align-items-center ">Learn More <i
                                                    className="fa-solid ps-1 fa-right-long"></i></a>
                                            </div>
                                    ...
                                    <a href="singleproduct.html" className="text-decoration-none ">
                                        <div className="card h-100" data-aos="fade-down">
                                            ...
                                            <div className="card-body">
                                                ...
                                                <p className="card-text">
                                                    The Bobcat® S590 Skid-Steer Loader is our highest-lifting and most powerful 500
                                                    model.
                                                </p>
                                                <a href="#" className=" d-flex justify-content-start align-items-center ">Learn More <i
                                                    className="fa-solid ps-1 fa-right-long"></i></a>
