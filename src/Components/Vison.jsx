            ...
            <main className='container'>
                ...
                <Carousel responsive={responsive} className='mb-5'>
                    ...
                    <div className='me-1 p-3'>
                        ...
                        <div
                            className="border-0 h-100 shadow rounded-3 card d-flex flex-column justify-content-center align-items-center">
                            <img className="card-img w-50  px-3 pt-3 rounded-circle" alt="slide-img" loading='lazy'
                            ...
                            <div className="card-body">
                                <p className="card-text text-center">
                                    <q>Kemach has been our trusted partner for years. Their Bobcat equipment is
                                        reliable, and their service team is always prompt and professional.</q>
                                </p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div className="card-body">
                                <p className="card-text text-center pb-4">
                                    <q>Exceptional service and top-quality equipment! Kemach’s team goes above and beyond to meet our needs.</q>
                                </p>
                            </div>
                        </div>
                    ...
                    <div className='me-1 p-3'>
                        ...
                        <div
                            ...
                            <div className="card-body">
                                <p className="card-text text-center pb-4">
                                    <q>Kemach consistently delivers dependable machinery with outstanding after-sales support. Highly recommended!</q>
                                </p>
                            </div>
                        </div>
                    ...
                    <div className='me-1 p-3'>
                        ...
                        <div
                            ...
                            <div className="card-body">
                                <p className="card-text text-center">
                                    <q>The team at Kemach is knowledgeable, and their commitment to customer satisfaction is impressive. We’ve had great experiences with them.</q>
                                </p>
                            </div>
                        </div>
                    ...
                    <div className='me-1 p-3'>
                        ...
                        <div
                            ...
                            <div className="card-body">
                                <p className="card-text text-center">
                                    <q>For over a decade, we’ve relied on Kemach for our equipment needs. Their service is unmatched, and their equipment performance is excellent.</q>
                                </p>
                            </div>
                        </div>
